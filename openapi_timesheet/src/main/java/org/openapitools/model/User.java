...
public class User {
  ...
  */
  ...
  @Schema(name = "username", example = "theUser", required = false)
  ...
  */
  ...
  @Schema(name = "lastName", example = "James", required = false)
  ...
  */
  ...
  @Schema(name = "email", example = "john@email.com", required = false)
  ...
  */
  ...
  @Schema(name = "password", example = "12345", required = false)
